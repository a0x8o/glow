...
# /databricks/conda/envs/dcs-minimal/lib/python3.7/site-packages/hail/backend/hail-all-spark.jar
RUN mkdir /databricks/jars
# COPY $hail_jar_path /databricks/jars
COPY /databricks/conda/envs/dcs-minimal/lib/python3.7/site-packages/hail/backend/hail-all-spark.jar /databricks/jars
